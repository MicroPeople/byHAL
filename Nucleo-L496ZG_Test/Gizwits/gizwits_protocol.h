...
* @{
*/
#define PRODUCT_KEY "b3cacc2857f94e3f93d46128bb8b012a"
/**@} */
/**@name Product Secret (产品密钥)
* @{
*/
#define PRODUCT_SECRET "d14255ded4674d3a93d562059ac78188"
/**@} */
...
#define CHIPTEMP_ADDITION                      -40
#define CHIPTEMP_MIN                           0
#define CHIPTEMP_MAX                           140
...
typedef enum
{
    ...
    LED_COLOR_VALUE1 = 1,//浪漫
    LED_COLOR_VALUE2 = 2,//护眼
    LED_COLOR_VALUE3 = 3,//自然
    LED_COLOR_VALUE_MAX,
} LED_COLOR_ENUM_T;
